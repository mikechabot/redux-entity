  ...
  _createClass(EntityLifecycle, [
    {
      ...
      value: function onSuccess(data, dispatch, getState) {
         ...
         */
        var dispatchedData = this.processStage(_types.ProcessorType.BeforeSuccess, data, dispatch, getState);
        /**
        ...
        this.processStage(_types.ProcessorType.AfterSuccess, dispatchedData, dispatch, getState);
        /**
    ...
    },
    {
      ...
      value: function onFailure(error, dispatch, getState) {
         ...
         */
        var dispatchedError = this.processStage(_types.ProcessorType.BeforeFailure, error, dispatch, getState);
        /**
        ...
        this.processStage(_types.ProcessorType.AfterFailure, dispatchedError, dispatch, getState);
