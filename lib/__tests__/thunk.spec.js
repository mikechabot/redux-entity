    ...
    describe('Processor Types', function () {
      describe('Processor Invocation', function () {
        it('should invoke the Success processor types', function (done) {
          ...
          var options = {
            processors:
              ((_processors = {}),
              _defineProperty(_processors, _types.ProcessorType.BeforeSuccess, beforeSpy),
              _defineProperty(_processors, _types.ProcessorType.AfterSuccess, afterSpy),
              _processors),
          };
        ...
        it('should invoke the Failure processor types', function (done) {
          ...
          var options = {
            processors:
              ((_processors2 = {}),
              _defineProperty(_processors2, _types.ProcessorType.BeforeFailure, beforeSpy),
              _defineProperty(_processors2, _types.ProcessorType.AfterFailure, afterSpy),
              _processors2),
          };
        ...
        it('should invoke the Success processor types with data, dispatch, and getState', function (done) {
          ...
          var options = {
            processors:
              ((_processors3 = {}),
              _defineProperty(_processors3, _types.ProcessorType.BeforeSuccess, function (data, dispatch, getState) {
              ...
              _defineProperty(_processors3, _types.ProcessorType.AfterSuccess, function (data, dispatch, getState) {
                expect(data).toEqual(promiseData);
                expect(_typeof(dispatch)).toEqual('function');
                expect(_typeof(getState)).toEqual('function');
                dispatch({
        ...
        it('should invoke the Failure processor types with data, dispatch, and getState', function (done) {
          ...
          var options = {
            processors:
              ((_processors4 = {}),
              _defineProperty(_processors4, _types.ProcessorType.BeforeFailure, function (error, dispatch, getState) {
              ...
              _defineProperty(_processors4, _types.ProcessorType.AfterFailure, function (error, dispatch, getState) {
                expect(error).toEqual(promiseError);
                expect(_typeof(dispatch)).toEqual('function');
                expect(_typeof(getState)).toEqual('function');
                dispatch({
      ...
      describe('BEFORE_SUCCESS', function () {
        it('should return the data as modified in the processor', function (done) {
          ...
          var options = {
            processors: _defineProperty({}, _types.ProcessorType.BeforeSuccess, function (data) {
      ...
      describe('BEFORE_FAILURE', function () {
        ...
        it('should return a new error', function (done) {
          var options = {
            processors: _defineProperty({}, _types.ProcessorType.BeforeFailure, function () {
              return newError;
            }),
          };
