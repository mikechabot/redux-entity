...
describe('Reducer', function () {
  ...
  describe('Request', function () {
    it('should set "isFetching" to true, and undefine the error', function () {
      var existingState = _defineProperty({}, entity, {
        isFetching: false,
  ...
  describe('Success', function () {
    it('should set "isFetching" to false, undefine the error, and set the payload', function () {
      var payload = {
        lastUpdated: lastUpdated,
        data: 123,
      };
  ...
  describe('Failure', function () {
    it('should set "isFetching" to false, undefine the data, and set the error', function () {
