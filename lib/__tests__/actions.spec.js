  ...
  describe('Generic', function () {
    describe('makeActionCreator', function () {
      ...
      it('should return a function', function () {
        expect(_typeof((0, _actions.makeActionCreator)(_types.ActionType.SUCCESS))).toEqual('function');
      });
      ...
      describe('Invoking the returned function', function () {
        it('should return an object containing the action type', function () {
          ...
          var action = (0, _actions.makeActionCreator)(_types.ActionType.SUCCESS);
        ...
        it('should return an object containing the action type, and the payload keys', function () {
          ...
          var action = (0, _actions.makeActionCreator)(_types.ActionType.SUCCESS, key1, key2);
    ...
    describe('makeEntityActionCreator', function () {
      ...
      it('should return a function', function () {
        expect(_typeof((0, _actions.makeEntityActionCreator)(_types.ActionType.SUCCESS, entity))).toEqual('function');
      });
      it('should throw an error if a type is not passed', function () {
        // @ts-ignore
        expect(function () {
      ...
      it('should throw an error if entity is not passed', function () {
        // @ts-ignore
        expect(function () {
          return (0, _actions.makeEntityActionCreator)(_types.ActionType.SUCCESS);
        }).toThrow(entityError);
      });
      describe('Invoking the returned function', function () {
        it('should return an object containing the action type', function () {
          ...
          var action = (0, _actions.makeEntityActionCreator)(_types.ActionType.SUCCESS, entity);
          expect(action()).toEqual(expectedAction);
        });
        it('should return an object containing the action type, and the payload keys', function () {
          var _payload2;
          ...
          var action = (0, _actions.makeEntityActionCreator)(_types.ActionType.SUCCESS, entity, key1, key2);
          expect(action(value1, value2)).toEqual(expectedAction);
        });
      });
    });
