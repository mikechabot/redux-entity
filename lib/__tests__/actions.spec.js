...
describe('Action Creators', function () {
  ...
  describe('Action Types', function () {
    ...
    describe('Reset', function () {
      it('should be a function', function () {
        expect(_typeof(_actions.ResetEntity)).toEqual('function');
      });
      it('should return an action object', function () {
        ...
        var action = (0, _actions.ResetEntity)(entity, date);
        expect(action).toEqual(expectedAction);
      });
    });
    describe('Delete', function () {
      it('should be a function', function () {
        expect(_typeof(_actions.DeleteEntity)).toEqual('function');
      });
      it('should return an action object', function () {
        var date = new Date();
        var expectedAction = {
        ...
        var action = (0, _actions.DeleteEntity)(entity);
        expect(action).toEqual(expectedAction);
      });
    });
  });
