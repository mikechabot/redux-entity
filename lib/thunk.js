...
var _entityLifecycle = require('./common/entity-lifecycle');

var _entityLifecycle2 = _interopRequireDefault(_entityLifecycle);
...
function loadEntity(name, promise, options) {
  ...
  var entityLifecycle = new _entityLifecycle2.default(name, options);
