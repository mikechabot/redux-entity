...
var fetchRequestCreator = function fetchRequestCreator(entity) {
  return makeEntityActionCreator(_types.ActionType.REQUEST, entity);
};
/**
...
var fetchSuccessCreator = function fetchSuccessCreator(entity) {
  return makeEntityActionCreator(
    _types.ActionType.SUCCESS,
    entity,
    _types.PayloadKey.DATA,
    _types.PayloadKey.LAST_UPDATED,
...
var ResetEntity = makeEntityActionCreator(_types.ActionType.RESET, ENTITY, _types.PayloadKey.LAST_UPDATED);
exports.ResetEntity = ResetEntity;
var DeleteEntity = makeEntityActionCreator(_types.ActionType.DELETE, ENTITY);
