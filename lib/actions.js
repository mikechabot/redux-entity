...
var fetchSuccessCreator = function fetchSuccessCreator(entity) {
  return makeEntityActionCreator(
    ...
    entity,
    _types.PayloadKeys.Data,
    _types.PayloadKeys.LastUpdated,
    _types.PayloadKeys.Append
  );
};
/**
...
var ResetEntity = function ResetEntity(entity) {
  ...
  return makeEntityActionCreator(_types.EntityActionType.Reset, entity, _types.PayloadKeys.LastUpdated)(lastUpdated);
};
