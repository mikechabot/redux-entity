...
EntityLifecycle.prototype.onLoad = function () {
  if (!this.config.isSilent()) {
    this.getDispatch()((0, _actionCreators.fetchRequest)(this.getEntityName())());
  }
};
...
EntityLifecycle.prototype.dispatchFetchSuccess = function (data) {
  this.dispatch((0, _actionCreators.fetchSuccess)(this.getEntityName())(data, Date.now(), this.config.doAppend()));
};

EntityLifecycle.prototype.dispatchFetchFailure = function (error) {
  this.dispatch((0, _actionCreators.fetchFailure)(this.getEntityName())(error, Date.now()));
};
