  ...
  _createClass(EntityLifecycle, [
    {
      ...
      value: function onSuccess(data, dispatch, getState) {
        ...
        this.processStage(_types.ProcessorType.AFTER_SUCCESS, data, dispatch, getState);
        /**
    ...
    },
    {
      ...
      value: function onFailure(error, dispatch, getState) {
        ...
        this.processStage(_types.ProcessorType.AFTER_FAILURE, error, dispatch, getState);
