...
function entityReducer() {
  ...
  switch (type) {
    case _types.ActionType.REQUEST: {
    ...
    case _types.ActionType.SUCCESS: {
    ...
    case _types.ActionType.FAILURE: {
      return _objectSpread(
        _objectSpread({}, state),
        {},
        {
...
function entities() {
  ...
  switch (type) {
    case _types.ActionType.RESET: // fall through

    case _types.ActionType.SUCCESS: // fall through

    case _types.ActionType.FAILURE: // fall through
